填充模板出错,FreeMarker template error:
The following has evaluated to null or missing:
==> mapperInterface  [in template "serviceImpl.ftl" at line 6, column 10]
...
FTL stack trace ("~" means nesting-related):
	- Failed at: ${mapperInterface.packageName}  [in template "serviceImpl.ftl" at line 6, column 8]
----
...
freemarker.core.InvalidReferenceException: [... Exception message was already printed; see it above ...]
	...
	at com.baomidou.plugin.idea.mybatisx.generate.template.FreeMakerFormatter.getFormattedContent(FreeMakerFormatter.java:77)
	at org.mybatis.generator.api.GeneratedJavaFile.getFormattedContent(GeneratedJavaFile.java:46)
	at com.baomidou.plugin.idea.mybatisx.generate.template.FreemarkerFile.getFormattedContent(FreemarkerFile.java:24)
	at com.baomidou.plugin.idea.mybatisx.generate.plugin.IntellijMyBatisGenerator.writeGeneratedJavaFile(IntellijMyBatisGenerator.java:244)
	at com.baomidou.plugin.idea.mybatisx.generate.plugin.IntellijMyBatisGenerator.generate(IntellijMyBatisGenerator.java:159)
	at com.baomidou.plugin.idea.mybatisx.generate.template.GenerateCode.generate(GenerateCode.java:156)
